...
Latest version
--------------
`Mobmetricalib-2.80`, `VERSION 2.80`, `API LEVEL 64`
----------------------------------------------------
* **mobmetricalib-2.80.jar** - jar file version.
* **mobmetricalib-2.80.aar** - aar file version.
* **mobmetricalib-2.80-javadoc.jar** - **Java**-doc for library.
...
----------------------------------------------------
* **mobmetricalib-2.78.jar** - jar file version.
* **mobmetricalib-2.78.aar** - aar file version.
* **mobmetricalib-2.78-javadoc.jar** - **Java**-doc for library.
* **native** - native libraries.
...
Version 2.78, Changelog
-----------------------
* Minor improvements and stabilization

`Mobmetricalib-2.77`, `VERSION 2.77`, `API LEVEL 62`
----------------------------------------------------
* **mobmetricalib-2.77.jar** - jar file version.
* **mobmetricalib-2.77.aar** - aar file version.
* **mobmetricalib-2.77-javadoc.jar** - **Java**-doc for library.
* **native** - native libraries.
...
`Mobmetricalib-2.76`, `VERSION 2.76`, `API LEVEL 61`
----------------------------------------------------
* **mobmetricalib-2.76.jar** - jar file version.
* **mobmetricalib-2.76.aar** - aar file version.
* **mobmetricalib-2.76-javadoc.jar** - **Java**-doc for library.
* **native** - native libraries.
...
Version 2.76, Changelog
-----------------------
* Added method YandexMetrica#reportReferralUrl(java.lang.String) for reporting URL for this installation. This might be required to track some specific traffic sources like Facebook
* Minor improvements and stabilization
--------------
...
`Mobmetricalib-2.80`, `VERSION 2.80`, `API LEVEL 64`
----------------------------------------------------
* **mobmetricalib-2.80.jar** - jar версия.
* **mobmetricalib-2.80.aar** - aar версия.
* **mobmetricalib-2.80-javadoc.jar** - **Java** - документация.
...
Version 2.80, Changelog
-----------------------
* Незначительные улучшения на Android 8

`Mobmetricalib-2.78`, `VERSION 2.78`, `API LEVEL 63`
----------------------------------------------------
* **mobmetricalib-2.78.jar** - jar версия.
* **mobmetricalib-2.78.aar** - aar версия.
* **mobmetricalib-2.78-javadoc.jar** - **Java** - документация.
* **native** - нативные библиотеки.
...
`Mobmetricalib-2.77`, `VERSION 2.77`, `API LEVEL 62`
----------------------------------------------------
* **mobmetricalib-2.77.jar** - jar версия.
* **mobmetricalib-2.77.aar** - aar версия.
* **mobmetricalib-2.77-javadoc.jar** - **Java** - документация.
* **native** - нативные библиотеки.
...
`Mobmetricalib-2.76`, `VERSION 2.76`, `API LEVEL 61`
----------------------------------------------------
* **mobmetricalib-2.76.jar** - jar версия.
* **mobmetricalib-2.76.aar** - aar версия.
* **mobmetricalib-2.76-javadoc.jar** - **Java** - документация.
* **native** - нативные библиотеки.
...
Version 2.76, Changelog
-----------------------
* Добавлен метод YandexMetrica#reportReferralUrl(java.lang.String), который репортит URL источника установки. Он может понадобится для трекинга отдельных источников установки, таких как Facebook
* Незначительные улучшения, исправления и повышение стабильности
